...
const JOBS_PAGE_COLUMNS =
  "id, created_at, title, category, location, pay_min, pay_max, clearance, description, apply_url, company_name, source_type, applications_under_review, og_title, og_description, og_image, og_site_name, poc_name, poc_email, poc_phone";
