...
// Security Enhancement: Use a secure random fallback password instead of a hardcoded string
// to prevent unauthorized bypass if the environment variable is missing.
