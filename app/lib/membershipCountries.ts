...
export const MEMBERSHIP_COUNTRY_HELPER =
  "Membership is currently only available to the United States, United Kingdom, Canada, Australia, New Zealand, Germany, France, Italy, the Netherlands, Norway, Denmark, and Sweden. If you would like your country to be considered for nomination please contact murphy@eod-hub.com to submit for an addition.";
