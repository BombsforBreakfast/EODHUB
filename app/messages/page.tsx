...
export default function MessagesPage() {
  ...
  // Check for ?with= param to auto-open or create a conversation
  useEffect(() => {
    if (!userId) return;
  ...
  async function loadConversations(uid: string) {
    ...
    // Get unread counts and last message previews
    ...
    (unreadData ?? []).forEach((m: { conversation_id: string; content: string; is_read: boolean; sender_id: string }) => {
  ...
  const InboxPane = (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", borderRight: isMobile ? "none" : "1px solid #e5e7eb" }}>
      <div style={{ padding: "16px 20px", fontWeight: 900, fontSize: 18, borderBottom: "1px solid #e5e7eb" }}>
        Messages
      </div>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontWeight: conv.unread_count > 0 ? 800 : 600, fontSize: 14 }}>
