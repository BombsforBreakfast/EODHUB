      ...
      <div style={{ marginTop: 24, ...card }}>
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
          ...
          <div
            ...
            style={{ position: "relative", width: profile?.is_employer ? 160 : 120, height: profile?.is_employer ? 72 : 120, borderRadius: profile?.is_employer ? 12 : "50%", overflow: "hidden", background: profile?.is_employer ? "#f8f8f8" : t.bg, border: profile?.is_employer ? `1px solid ${t.border}` : undefined, display: "flex", alignItems: "center", justifyContent: "center", color: t.textMuted, fontWeight: 700, flexShrink: 0, cursor: uploadingAvatar ? "not-allowed" : "pointer", padding: profile?.is_employer ? 8 : 0, boxSizing: "border-box" }}
          >
            {profile?.photo_url ? (
