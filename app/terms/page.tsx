  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, color: t.text, padding: "32px 20px" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        <h1 style={{ margin: 0, fontSize: 32, fontWeight: 900 }}>Terms of Service</h1>
        ...
        <div style={{ marginTop: 18, display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          <Link href="/guidelines" style={{ color: "#2563eb", textDecoration: "none", fontWeight: 700 }}>Community Guidelines</Link>
        </div>
      </div>
    </div>
  );
